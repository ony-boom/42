...
/*   Updated: 2024/03/17 22:44:11 by rony-lov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/17 14:42:10 by rony-lov          #+#    #+#             */
/*   Updated: 2024/03/17 22:19:24 by rony-lov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_config(const char *str, t_format_config *config)
{
	...
	if (*str == MINUS || *str == ZERO)
		...
		config->modifier_config.max_width = get_max_width((char *)str,
				&config->format_len);
	...
	config->specifier = (t_format_specifier) * (str + config->format_len);
}
